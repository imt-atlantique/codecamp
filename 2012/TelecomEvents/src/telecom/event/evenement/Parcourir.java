...
public class Parcourir extends Activity {
	private ListView maListViewPerso;
	/** Called when the activity is extends first created. */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(telecom.event.evenement.R.layout.parcourir);
   ...
   //Création de la ArrayList qui nous permettra de remplire la listView
        ...
        map.put("titre", "Le Bon la Brut et le Truand ");
        //on insère un élément description que l'on récupérera dans le textView description créé dans le fichier affichageitem.xml
        map.put("description", "Dimanche 29 Janvier au Grand Amphi");
        //on insère la référence à l'image (convertit en String car normalement c'est un int) que l'on récupérera dans l'imageView créé dans le fichier affichageitem.xml
        map.put("img", String.valueOf(telecom.event.evenement.R.drawable.bonbrut));
      ...
      //Création d'une HashMap pour insérer les informations du premier item de notre listView
        ...
        map = new HashMap<String, String>();
        map.put("titre", "Sherlock Holmes 2");
        map.put("description", "Cinéma Multiplexe de Brest Samedi à 16H00");
        map.put("img", String.valueOf(telecom.event.evenement.R.drawable.sherlock));
        listItem.add(map);
 
        map = new HashMap<String, String>();
        map.put("titre", "Old Boy");
        map.put("description", "Samedi 28 Janvier au Grand Amphi");
        map.put("img", String.valueOf(telecom.event.evenement.R.drawable.old_boy));
        listItem.add(map); 
        ...
        maListViewPerso.setOnItemClickListener(new OnItemClickListener() {
			@SuppressWarnings("unchecked")
         	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
        		...
        		AlertDialog.Builder adb = new AlertDialog.Builder(Parcourir.this);
    ...
    /* // Gestion des boutons du menu
        ...
        btnParcourir.setOnCickListener(
        new OnClickListener(){
        public void onClick(View viewParam) {
       ...
       /* EvenementDBAdapter EAdapt = new EvenementDBAdapter(this);
        ...
        Cursor cursor = EAdapt.getAllEvenement();
        startManagingCursor(cursor);
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,R.id.listView1,cursor,new String[]{EvenementDBAdapter.COLONNE_NOM_EVENEMENT,EvenementDBAdapter.COLONNE_DESCRIPTION}
        ,new int[]{telecom.event.evenement.R.id.titre, telecom.event.evenement.R.id.description});
        this.maListViewPerso.setAdapter(adapter);
